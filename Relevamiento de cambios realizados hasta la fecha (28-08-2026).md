...
h1. Errores parcheados temporalmente solo en el servidor de producción de revistas
...
Este error (explicado en https://trac.prebi.unlp.edu.ar/issues/14552) ya fue arreglado. Esta solución ya está subida a GitHub pero aún no está en la rama estable.

h1. Nuevas funcionalidades