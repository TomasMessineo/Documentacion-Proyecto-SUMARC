...
Hacer un ticket Issues que tenga de descripción las cosas pendeiwntes. Hacer una subtarea que sea arreglo spara sumarc 2.1 donde agrego todo esto que anoté de arreglos hechos, sumando el del HTML.
